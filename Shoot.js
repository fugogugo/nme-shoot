...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("images/MyShip.png",loader);
...
var GameScene = function(windowWidth,windowHeight) {
	Scene.call(this);
	this.myShip = new MyShip(windowWidth,windowHeight);
...
var Main = function() {
	...
	this.jeashSetWidth(600.0);
	this.jeashSetHeight(700.0);
...
var MyShip = function(windowWidth,windowHeight) {
	...
	var bitmap = new jeash.display.Bitmap(nme.installer.Assets.getBitmapData("images/MyShip.png"));
	var graphic = new jeash.display.Sprite();
	graphic.addChild(bitmap);
	Mover.call(this,windowWidth / 2.0,windowHeight - 100.0,graphic);
	this.pressedUp = false;
	this.pressedDown = false;
	this.pressedLeft = false;
	this.pressedRight = false;
	com.eclecticdesignstudio.control.KeyBinding.addOnPress(jeash.ui.Keyboard.UP,$bind(this,this.keyboard_onPressUp));
	com.eclecticdesignstudio.control.KeyBinding.addOnPress(jeash.ui.Keyboard.DOWN,$bind(this,this.keyboard_onPressDown));
	com.eclecticdesignstudio.control.KeyBinding.addOnRelease(jeash.ui.Keyboard.UP,$bind(this,this.keyboard_onReleaseUp));
	com.eclecticdesignstudio.control.KeyBinding.addOnRelease(jeash.ui.Keyboard.DOWN,$bind(this,this.keyboard_onReleaseDown));
	com.eclecticdesignstudio.control.KeyBinding.addOnPress(jeash.ui.Keyboard.LEFT,$bind(this,this.keyboard_onPressLeft));
	com.eclecticdesignstudio.control.KeyBinding.addOnPress(jeash.ui.Keyboard.RIGHT,$bind(this,this.keyboard_onPressRight));
	com.eclecticdesignstudio.control.KeyBinding.addOnRelease(jeash.ui.Keyboard.LEFT,$bind(this,this.keyboard_onReleaseLeft));
	com.eclecticdesignstudio.control.KeyBinding.addOnRelease(jeash.ui.Keyboard.RIGHT,$bind(this,this.keyboard_onReleaseRight));
};
...
MyShip.prototype = $extend(Mover.prototype,{
	update: function() {
		if(this.pressedUp && this.cy >= 0.0) this.setY(this.cy - 5.0);
		if(this.pressedDown && this.cy <= this.windowHeight) this.setY(this.cy + 5.0);
		if(this.pressedLeft && this.cx >= 0.0) this.setX(this.cx - 5.0);
		if(this.pressedRight && this.cx <= this.windowWidth) this.setX(this.cx + 5.0);
	}
...
jeash.text.TextField.prototype = $extend(jeash.display.InteractiveObject.prototype,{
	...
	,__properties__: $extend(jeash.display.InteractiveObject.prototype.__properties__,{set_autoSize:"SetAutoSize",set_borderColor:"SetBorderColor",set_background:"SetBackground",set_backgroundColor:"SetBackgroundColor",set_border:"SetBorder",set_wordWrap:"SetWordWrap",set_type:"SetType",get_type:"GetType"})
});
...
nme.Lib.__properties__ = {get_current:"nmeGetCurrent"}
